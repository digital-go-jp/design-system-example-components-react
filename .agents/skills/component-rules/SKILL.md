...
- Do not use stock Tailwind border-radius values (`rounded-md`, `rounded-lg`, etc.). Use the plugin's `rounded-4`, `rounded-6`, `rounded-8`, `rounded-12`, `rounded-16`, `rounded-24`, `rounded-32`, `rounded-full` tokens instead.
